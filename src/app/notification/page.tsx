            ...
            <div className="relative flex flex-col flex-1 w-full max-w-md overflow-hidden">
                ...
                <div className="relative bottom-20 flex flex-col py-6 w-full">
                    <div className="flex justify-between items-center mb-3 pr-[25px] w-full">
                        <span className="ml-6 text-[26px] text-white leading-[31px] tracking-[-1%]">Notification Center</span>
                        ...
                        <div className="flex flex-col flex-1 justify-center">
                            <span className="mb-1 font-semibold text-[15px] text-white leading-[18px] tracking-[-1%]">🔥 Your DTE plan is waiting!</span>
                            <span className="font-light text-[14px] text-white leading-[19px] tracking-[-1%]">Time to lock in! Complete today’s Discover, Train, Execute plan.</span>
                        </div>
                    </div>
                </div>
