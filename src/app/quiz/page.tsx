...
export default function QuestionsPage() {
  ...
  const [isFirstAnswerCorrect, setIsFirstAnswerCorrect] = useState<
    boolean | null
  >(null);
          ...
          <div className="h-full w-full flex flex-col">
              ...
              <div className="flex-1 flex flex-col">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">
                    True or False: It&apos;s best to wait until you feel
                    completely confident before taking action.
                  </h2>
                </div>
            ...
            {currentSlide === 2 && (
              <div className="flex-1 flex flex-col relative">
                <div className="mb-[30px] min-h-[44px]">
                  <h2 className="text-[20px] leading-[24px] font-medium text-white">
                    Why do you think having a planned recovery word/phrase
                    works?
                  </h2>
                </div>
